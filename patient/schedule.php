                       ...
                       <center>
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                // This line starts a for loop. The loop will run as many times as there are rows in the result set ($result->num_rows).
                                    echo "<tr>";
                                    for($q=0;$q<3;$q++){

                                        // This is an inner loop that will execute three times in each outer loop iteration.

                                        $row=$result->fetch_assoc();

                                        // This line fetches the next row from the result set and stores it in the $row variable as an associative array.
                                        if (!isset($row)){
                                            break;

                                            // This checks if $row is set (i.e., if fetch_assoc() has successfully fetched a row).
                                        };
                                        $scheduleid=$row["scheduleid"];
                                        // $scheduleid stores the schedule ID from the scheduleid column.
                                        $title=$row["title"];
                                        // $title stores the value from the title column.
                                        $docname=$row["docname"];
                                        // $docname stores the value from the docname column (likely the doctor's name).
                                        $scheduledate=$row["scheduledate"];
                                        // $scheduledate stores the value from the scheduledate column.
                                        $scheduletime=$row["scheduletime"];
                                        // $scheduletime stores the value from the scheduletime column.

                                        if($scheduleid==""){
                                            break;
                                            // This checks if the scheduleid is empty. If it is, the loop breaks, meaning no more rows will be processed.
                                        }
